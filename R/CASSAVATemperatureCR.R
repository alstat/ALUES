#' Cassava Temperature Requirement for Land Evaluation
#' 
#' A dataset containing the temperature characteristics of the crop requirements for farming Cassava.
#' 
#' @details 
