#' Mango soil requirement for land evaluation
    #' 
    #' A dataset containing the soil characteristics of the crop requirements for farming Mango.
    #' 
    #' @details 
...
#' \item SumBCc - Sum of basic cations (cmol (+)/kg of clay)
#' \item pHH2O - pH H2O
