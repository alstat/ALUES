#' Irrigated Rice Soil Requirement for Land Evaluation
#' 
#' A dataset containing the Soil characteristics of the crop requirements for farming Irrigated Rice.
#' 
#' @details 
...
#'  \item ESP - ESP (\%)
#'  \item pHH2O - pH H2O
#'  \item SoilTe - classes of soil texture (Soil Taxonomy)
#' }
#' 
#' @seealso 
#' \itemize{
