#' Pea temp requirement for land evaluation
    #' 
    #' A dataset containing the temp characteristics of the crop requirements for farming Pea.
    #' 
    #' @details 
...
#' \item TmMinAv0 - Mean min. temp. at germination (°C)
#' }
    #' @seealso 
    #' \itemize{
