#' Rainfed Bunded Rice temp requirement for land evaluation
    #' 
    #' A dataset containing the temp characteristics of the crop requirements for farming Rainfed Bunded Rice.
    #' 
    #' @details 
