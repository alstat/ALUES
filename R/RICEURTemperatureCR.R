#' Rainfed Upland Rice Temperature Requirement for Land Evaluation
#' 
#' A dataset containing the Temperature characteristics of the crop requirements for farming Rainfed Upland Rice.
#' 
#' @details 
