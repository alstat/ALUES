#' Pineapple terrain requirement for land evaluation
    #' 
    #' A dataset containing the terrain characteristics of the crop requirements for farming Pineapple.
    #' 
    #' @details 
