#' Groundnuts soil requirement for land evaluation
    #' 
    #' A dataset containing the soil characteristics of the crop requirements for farming Groundnuts.
    #' 
    #' @details 
...
#' \item CaCO3 - CaCO3 (\%)
#' \item Gyps - Gypsum (\%)
#' \item CECs - Apparent CEC Soil (cmol (+)/kg soil)
