#' Groundnuts water requirement for land evaluation
    #' 
    #' A dataset containing the water characteristics of the crop requirements for farming Groundnuts.
    #' 
    #' @details 
