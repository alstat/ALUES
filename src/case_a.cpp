  ...
  for (i = 0; i < df_row; ++i) {
    ...
    if (mfNum == 1) {
      if ((df(i, w) < Min) || (df(i, w) >= Max)) {
        ...
        if (wt == 0) {
          ...
          if (bias == 1) {
            l1 = 0; l2 = 1 - (c / Max); l3 = 1 - (b / Max); l4 = 1 - (a / Max); l5 = Max / Max;
          }
    ...
    if (mfNum == 3) {
      if (df(i, w) < Min) {
        ...
        if (wt == 0) {
          score(i, w) = exp(-(1 / 2) * pow(((df(i, w) - Min) / sigma), 2));
          if (bias == 1) {
            l1 = 0; l2 = exp(-(1 / 2) * pow(((c - Min) / sigma), 2));
            l3 = exp(-(1 / 2) * pow(((b - Min) / sigma), 2));
            l4 = exp(-(1 / 2) * pow(((a - Min) / sigma), 2));
            l5 = 1;
          }
          if ((score(i, w) >= l1) && (score(i, w) < l2)) {
            suiClass(i, w) = "N";
          ...
          if ((score(i, w) >= l1) && (score(i, w) < l2)) {
            score(i, w) = wt * ((exp((-1 / 2) * pow(((c - Min) / sigma), 2))) / 3);
            suiClass(i, w) = "N";
          } else if ((score(i, w) >= l2) && (score(i, w) < l3)) {
            score(i, w) = wt * ((exp((-1 / 2) * pow(((b - Min) / sigma), 2)) - exp((-1 / 2) * pow(((c - Min) / sigma), 2))) / 3) + exp((-1 / 2) * pow(((c - Min) / sigma), 2));
            suiClass(i, w) = "S3";
          } else if ((score(i, w) >= l3) && (score(i, w) < l4)) {
            score(i, w) = wt * ((exp((-1 / 2) * pow(((a - Min) / sigma), 2)) - exp((-1 / 2) * pow(((b - Min) / sigma), 2))) / 3) + exp((-1 / 2) * pow(((b - Min) / sigma), 2));
            suiClass(i, w) = "S2";
          } else if ((score(i, w) >= l4) && (score(i, w) <= l5)) {
            score(i, w) = wt * ((1 - exp((-1 / 2) * pow(((a - Min) / sigma), 2))) / 3) + exp((-1 / 2) * pow(((a - Min) / sigma), 2));
            suiClass(i, w) = "S1";
          }
        }
      }
